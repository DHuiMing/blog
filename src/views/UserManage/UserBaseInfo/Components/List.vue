<template>
  <section>
    ...
    >
      ...
      <el-table-column :label="$t('table.RegistClient')" prop="registerClient" width="200px" align="center"></el-table-column>
      <el-table-column :label="$t('table.RegistrationChannel')" prop="registClient" width="300px" align="center"></el-table-column>
