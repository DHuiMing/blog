<template>
  <section>
    ...
    >
      ...
      <el-table-column :label="$t('tab.OrderNumber')" prop="orderNumber" fixed width="300px" align="center"></el-table-column>
      <el-table-column :label="$t('tab.AuditStatus')" prop="auditState" width="180px" align="center">
        <template slot-scope="scope">
          <span>{{ borrowStateList[scope.row.auditState]}}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('tab.Auditor')" prop="sysUserName" width="180px" align="center"></el-table-column>
      ...
      <el-table-column :label="$t('tab.AuditTime')" prop="createTime" width="180px" align="center"></el-table-column>
      <el-table-column :label="$t('tab.ApplyTime')" prop="orderTime" width="180px" align="center"></el-table-column>
      ...
      <el-table-column :label="$t('tab.Theorderstatus')" fixed="right" width="200px" align="center">
        <template slot-scope="scope">
          <span>{{ allBorrowState[scope.row.orderState]}}</span>
        </template>
      </el-table-column>
  ...
  methods: {
    ...
    getList() {
      ...
      _this
        .$axios({
          method: "post",
          url: "/manage/risk/borrowAuditList.htm",
          data: _this.params
        })
        .then(res => {
