<template>
  <section>
    ...
    >
      ...
      <el-table-column label="审核状态" prop="auditState" width="180px" align="center">
        <template slot-scope="scope">
          <span>{{ borrowStateList[scope.row.auditState]}}</span>
        </template>
      </el-table-column>
      <el-table-column label="审核人" prop="sysUserName" width="180px" align="center"></el-table-column>
      ...
      <el-table-column label="审核时间" prop="createTime" width="180px" align="center"></el-table-column>
      <el-table-column label="下单时间" prop="orderTime" width="180px" align="center"></el-table-column>
