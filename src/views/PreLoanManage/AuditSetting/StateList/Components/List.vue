<template>
  <section>
    ...
    >
      ...
      <el-table-column label="省份" prop="value" fixed align="center" width="120px"></el-table-column>
      <el-table-column label="城市" prop="createTime" width="220px" align="center"></el-table-column>
      <el-table-column label="创建时间" prop="mender" width="180px" align="center"></el-table-column>
      ...
      <el-form :model="formInit" style="margin-right: 20px" ref="form">
        <el-row :gutter="20">
          ...
          <el-col :span="20">
            <el-form-item
              ...
              :rules="[{ required: true, message: '省份名称不能为空'}]"
            >
        ...
        <el-row :gutter="20">
            ...
            <el-form-item
              ...
              prop="value"
              :label-width="formLabelWidth"
              :rules="[{ required: true, message: '身份证号码前两位'}]"
            >
              <el-input v-model="formInit.value" autocomplete="off"></el-input>
            </el-form-item>
          </el-col>
  ...
  methods: {
    ...
    getList() {
      ...
      _this
        .$axios({
          method: "post",
          url: "/manage/risk/listIdnoProvinceDict.htm",
          data: _this.params
        })
        .then(res => {
